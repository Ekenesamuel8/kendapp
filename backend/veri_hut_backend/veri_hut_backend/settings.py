"""
Django settings for veri_hut_backend project.
...
SECRET_KEY = 'django-insecure-v0jmy1lj426!-v8_gacd(st!zii@_sb&f!qsl%tz*mg+vzi&4f'
...
ROOT_URLCONF = 'veri_hut_backend.urls'
